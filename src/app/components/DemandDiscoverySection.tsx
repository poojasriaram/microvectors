            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-20">
                ...
                <div className="text-center max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="mt-12 p-8 bg-slate-50/80 rounded-2xl border border-slate-200 text-left max-w-4xl mx-auto shadow-sm">
                        <h4 className="font-bold text-slate-900 mb-6 text-lg tracking-tight">Best Fit ICP for Demand Discovery</h4>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-3">Target Organizations</h5>
                                <ul className="space-y-3">
                                    {[
                                        "Companies entering new markets, verticals, or regions",
                                        "Revenue teams missing early-stage buying signals",
                                        "ABM teams struggling to identify real in-market accounts"
                                    ].map((item, i) => (
                            ...
                            <div>
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-3">Roles That Gain Immediate Value</h5>
                                <ul className="space-y-3">
                                    {[
                                        "Head of Demand Generation",
                                        "ABM & Enterprise Sales Leaders",
                                        "Market Expansion & Strategy Teams"
                                    ].map((item, i) => (
                                        <li key={i} className="flex items-start gap-3 text-sm text-slate-600 leading-relaxed font-medium">
