...
export default function DemandDiscoverySection() {
    ...
    return (
        <section className="py-24 bg-white relative border-t border-slate-100 overflow-hidden">
            {/* Background Decorations - Variant Color to Distinguish */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-purple-50/50 rounded-full blur-[100px]" />
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {portfolio.map((item, i) => {
                            ...
                            return (
                                <Card key={i} className="border-slate-200 hover:border-purple-200 hover:shadow-xl transition-all duration-300 group">
                        ...
                        <div className="lg:w-3/4">
                            <div className="bg-slate-900 rounded-3xl p-8 md:p-10 text-white shadow-2xl overflow-hidden relative min-h-[500px]">
                                ...
                                <div className="relative z-10 grid md:grid-cols-2 gap-12">
                                    ...
                                    <div className="space-y-8">
                                        <div>
                                            <h4 className="flex items-center gap-2 text-purple-300 font-bold mb-4 uppercase tracking-wider text-sm">
                                                <CheckCircle2 className="w-5 h-5" /> Solutions & Benefits
                                            </h4>

                                            <div className="space-y-6">
                                                <div className="bg-purple-500/10 p-4 rounded-xl border border-purple-500/20">
                                                    <h5 className="font-semibold text-purple-50 mb-2">Solutions Provided</h5>
                                                    <ul className="space-y-2">
                                                ...
                                                <div className="bg-purple-500/10 p-4 rounded-xl border border-purple-500/20">
                                                    <h5 className="font-semibold text-purple-50 mb-2">Key Benefits</h5>
                                                    <ul className="space-y-2">
