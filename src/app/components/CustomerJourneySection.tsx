            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-20">
                ...
                <div className="text-center max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="mt-12 p-8 bg-slate-50/80 rounded-2xl border border-slate-200 text-left max-w-4xl mx-auto shadow-sm">
                        <h4 className="font-bold text-slate-900 mb-6 text-lg tracking-tight">Designed for Experience-Driven Revenue Teams</h4>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-3">Perfect for:</h5>
                                <ul className="space-y-3">
                                    {[
                                        "Organizations with complex, multi-stakeholder buying journeys",
                                        "Teams experiencing funnel leakage and stalled deals",
                                        "Leaders optimizing conversion, deal size, and sales velocity"
                                    ].map((item, i) => (
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 h-full shadow-sm flex flex-col justify-center">
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-2">ICP Trigger</h5>
                                <p className="text-slate-700 text-base italic leading-relaxed">
                                    "Conversion drops despite strong lead flow."
                                </p>
                            </div>
                        </div>
                    </div>
