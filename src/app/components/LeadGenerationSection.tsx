            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-20">
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {kpis.map((stat, i) => (
                            <div key={i} className={`bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${i === kpis.length - 1 ? 'md:col-span-2 lg:col-span-3 lg:w-1/3 lg:mx-auto' : ''}`}>
