...
import { performanceMarketingData } from '../../data/performanceMarketing';
import { ArrowRight, CheckCircle2, XCircle, Zap } from 'lucide-react';
import { Card, CardContent } from './ui/card';

export default function PerformanceMarketingSection() {
    const { title, tagline, description, kpis, portfolio, verticalTabs } = performanceMarketingData;
    ...
    return (
        <section className="py-24 bg-white relative border-t border-slate-100 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-blue-50/50 rounded-full blur-[100px]" />
                <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-indigo-50/50 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-20">
                ...
                <div className="text-center max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="mt-12 p-8 bg-slate-50/80 rounded-2xl border border-slate-200 text-left max-w-4xl mx-auto shadow-sm">
                        <h4 className="font-bold text-slate-900 mb-6 text-lg tracking-tight">Designed for Performance-Driven Marketing Leaders</h4>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-3">This engine is built for:</h5>
                                <ul className="space-y-3">
                                    {[
                                        "Marketing leaders accountable for pipeline contribution",
                                        "Teams facing rising CAC and declining ROAS",
                                        "Organizations demanding closed-loop revenue attribution"
                                    ].map((item, i) => (
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 h-full shadow-sm flex flex-col justify-center">
                                <h5 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-2">ICP Reality</h5>
                                <p className="text-slate-700 text-base italic leading-relaxed">
                                    "Marketing spend is increasing — but confidence in ROI is declining."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 mt-2">Measurable outcomes from AI-driven execution</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {kpis.map((stat, i) => (
                            <div key={i} className={`bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${i === kpis.length - 1 && kpis.length % 4 !== 0 ? 'md:col-span-2 lg:col-span-1' : ''}`}>
                ...
                <div className="space-y-8">
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 mt-2">Our performance marketing capabilities</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="space-y-10">
                    <div className="text-center">
                        <h3 className="text-2xl font-bold text-slate-900">Operational Excellence</h3>
                        <p className="text-slate-500 mt-2">Solving critical marketing challenges</p>
                    </div>
