...
export function CTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background to-surface/50 py-24 border-t border-border/40">
      ...
      <div className="relative mx-auto max-w-6xl px-6 z-10 text-center">
        {/* Title */}
        <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-foreground max-w-3xl mx-auto leading-[1.12]">
          Ready to{" "}
        ...
        {/* Description */}
        <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed font-sans font-medium">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-14">
          ...
          <div className="premium-card flex flex-col items-center justify-between p-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-muted-foreground font-sans mb-6 font-medium">
          ...
          <div className="premium-card flex flex-col items-center justify-between p-8 text-center">
            <div className="flex flex-col items-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-surface text-muted-foreground mb-5">
