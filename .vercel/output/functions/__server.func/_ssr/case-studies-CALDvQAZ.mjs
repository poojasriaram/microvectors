...
import "./SectionHeading-C-MwxatC.mjs";
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Case Studies", title: "Production AI, measured in outcomes", description: "A selection of recent enterprise engagements. All client identities anonymized per NDA." }),
